...
Please extend the players table by the logo. Add a button to the right of "hide me" and call it "show". When the user clicks on the logo, display the logo inside a new "td" element of the "tr" table row.
